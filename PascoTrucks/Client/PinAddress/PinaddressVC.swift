...
protocol getAddressWithLatLong: AnyObject {
    func addressWithLatLong(address:String?, latLong:CLLocationCoordinate2D?)
     
}

class PinaddressVC: UIViewController,GMSAutocompleteViewControllerDelegate, GMSMapViewDelegate, CLLocationManagerDelegate
{
