...
class LocationManager: NSObject, CLLocationManagerDelegate {
    ...
    override init() {
        ...
        locationManager.allowsBackgroundLocationUpdates = true // Allow background location updates
        locationManager.pausesLocationUpdatesAutomatically = false // Prevent location updates from pausing automatically
        ...
        geocoder.reverseGeocodeLocation(location) { [weak self] (placemarks, error) in
            ...
            if let placemark = placemarks?.first {
                ...
                if let dialingCode = self.phoneNumberKit.countryCode(for: isoCountryCode) {
                    ...
                    print("Dialing Code: \(self.dialingPhoneCode ?? "")")
                } else {
                ...
                UserDefaults.standard.setValue(self.dialingPhoneCode, forKey: "countryCode")
            }
        }
    }
